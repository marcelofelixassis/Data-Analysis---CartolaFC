...
switch($categoriaget){
    ...
    case 'total_peso':
        ...
        FROM results2015p p JOIN fotos f ON p.id = f.id WHERE p.posicao_id = '$posicaoget' ORDER by $categoriaget ASC LIMIT 5");
    ...
    case 'total_fs':
        ...
        FROM results2015 p JOIN fotos f ON p.id = f.id WHERE p.posicao_id = '$posicaoget' ORDER by $categoriaget ASC LIMIT 5");
    ...
    case 'total_g':
        ...
        FROM results2015 p JOIN fotos f ON p.id = f.id WHERE p.posicao_id = '$posicaoget' AND p.total_g != 0 ORDER by $categoriaget ASC LIMIT 5");
    ...
    case 'total_dd':
        ...
        FROM results2015 p JOIN fotos f ON p.id = f.id WHERE p.posicao_id = '$posicaoget' AND p.total_dd != 0 ORDER by $categoriaget ASC LIMIT 5");
